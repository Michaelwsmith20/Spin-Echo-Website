    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 text-white pb-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-6 glass-panel border-white/10 bg-[#0F1115]">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 px-6 py-2.5 bg-spinecho-accent text-white text-[10px] font-bold uppercase tracking-[0.2em] rounded-lg shadow-lg shadow-spinecho-accent/20 hover:bg-blue-600 transition-all">
        ...
        <div className="lg:col-span-2 glass-panel p-6 bg-[#0F1115] relative overflow-hidden text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full">
            <div className="lg:col-span-8 relative h-72 lg:h-80 rounded-xl border border-white/5 bg-black flex items-center justify-center overflow-hidden">
               <img src="https://i.postimg.cc/K8w83Fbz/digitaltwin.png" alt="Hardware Twin" className="w-full h-full object-cover opacity-90 brightness-110" />
               <AnimatePresence>
                 {pulseActive && (
