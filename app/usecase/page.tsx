...
export default function UseCasePage() {
  ...
  const useCases = [
    ...
    },
    {
      ...
      whyHard: "Turbines are highly sensitive to composition fluctuations. Relying on inferred blending ratios or slow chromatography creates operational risk.",
      ...
      <section className="pt-48 pb-20 px-6 bg-gradient-to-b from-spinecho-accent/5 to-transparent">
        <div className="max-w-7xl mx-auto text-left">
          ...
          <h1 className="text-5xl lg:text-8xl font-bold text-white mb-8 tracking-tight leading-[1.05]">
            ...
            <span className="text-spinecho-accent">Across the Energy Stack.</span>
          </h1>
          <p className="text-xl lg:text-2xl text-spinecho-slate max-w-2xl leading-relaxed text-left">
      ...
      <section className="pb-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Fixed Installation - Now links to Product Specs */}
            <div className="glass-panel p-1 border-white/10 bg-white/5 hover:border-spinecho-accent/30 transition-all duration-700 overflow-hidden group">
               <div className="bg-[#0A0C10] rounded-xl flex flex-col h-full overflow-hidden">
                 <div className="w-full aspect-video bg-black overflow-hidden relative">
                    <img 
                      src="https://i.postimg.cc/d1qdDx7M/Fixed-Install.png" 
                      alt="Fixed Installation" 
                 ...
                 <div className="p-8 lg:p-12 flex flex-col flex-grow text-left">
                    ...
                    <p className="text-white/80 leading-relaxed mb-10 flex-grow">Permanently installed at wellheads or production facilities. Designed for continuous unattended operation where long term stability is critical.</p>
                    
                    {/* UPDATED: Functional Link to Specifications */}
                    <Link 
                      href="/product#specs" 
                      className="w-full py-4 border border-white/10 text-white font-bold uppercase text-[10px] tracking-[0.3em] rounded hover:bg-white hover:text-black transition-all flex items-center justify-center"
                    >
                      View Specifications
                    </Link>
                 </div>
            ...
            {/* Measurement Service - Links to Partner Modal */}
            <div className="glass-panel p-1 border-spinecho-accent/20 bg-spinecho-accent/5 hover:border-spinecho-accent/50 transition-all duration-700 overflow-hidden group">
               <div className="bg-[#0A0C10] rounded-xl flex flex-col h-full overflow-hidden">
                 <div className="w-full aspect-video bg-black overflow-hidden relative">
                    <img 
                      src="https://i.postimg.cc/mDbMh5P8/mobilemeter.png" 
                      alt="Mobile Service" 
                      className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" 
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent pointer-events-none" />
                 ...
                 <div className="p-8 lg:p-12 flex flex-col flex-grow text-left">
                    ...
                    <p className="text-white/80 leading-relaxed mb-10">A fully integrated containerised system. Ideal for pilot deployments, diagnostics, and short term flow assurance campaigns.</p>
                    ...
                    <div className="mb-10 p-6 bg-spinecho-accent/5 border border-spinecho-accent/20 rounded-lg">
                      ...
                      <p className="text-white text-sm leading-relaxed mb-4">Are you a measurement service provider looking to replace legacy tank separation units with high fidelity NMR?</p>
                      <button onClick={() => setIsPartnerModalOpen(true)} className="text-spinecho-accent font-bold text-[10px] uppercase tracking-widest hover:underline block">Partner with us →</button>
                    </div>
